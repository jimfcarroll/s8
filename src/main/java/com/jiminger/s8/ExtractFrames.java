...
public class ExtractFrames {
    ...
    /** The main method. */
    public static void main(final String[] args) throws IOException, MinimizerException {
        ...
        try(final CvRaster.Closer closer = new CvRaster.Closer()) {
            ...
            if(writeDebugImages)
                ImageFile.writeImageFile(transform.gradDirMask.getMaskRaster(), outDir + File.separator + "tmpgradmask.bmp");
            ...
            final CvMat sprocketInfoTiledImage = closer.add(new CvMat(origImageHeight, origImageWidth, CvType.CV_8UC1));
            ...
            for(int i = 0; i < numFrames; i++) {
                ...
                if(sprocketEdgePiece != null) {
                    ...
                    Utils.drawCircle(Utils.closest(frameReference, sprocketEdgePiece.edge), sprocketInfoTiledImage, cyan);
                }
                if(farEdgePiece != null) {
                    ...
                    Utils.drawCircle(closest, sprocketInfoTiledImage, cyan);
                    Utils.drawLine(frameReference, closest, sprocketInfoTiledImage, cyan);
                }
                ...
                // double distPix = PolarLineFit.perpendicularDistance(frameReference,sprocketEdgePiece.c,
                // sprocketEdgePiece.r) +
                // PolarLineFit.perpendicularDistance(frameReference,farEdgePiece.c, farEdgePiece.r);
                //
                // calcedEdgeResDPI = (distPix * FilmSpec.mmPerInch) /
                // FilmSpec.filmAttribute(filmType,FilmSpec.filmWidthIndex);
                // }
